...
class TetrisGame():
    ...
    def __init__(self, screen):
        ...
        self.loser_flag = 'player1_lost.txt'
        self.death_message = "PLAYER 1 LOST!"
        self.player_loser_flag = "player2_lost.txt"
    ...
    def main(self, win):
        ...
        level_time = 0
        score = 0
        # Add this at the start to accept shared pause state
        ...
        while run:
            ...
            if self.check_lost(self.locked_positions):
                ...
                run = False
                self.update_score(score)
            if os.path.exists(self.ai_loser_flag) or os.path.exists(self.player_loser_flag):
                pygame.mixer.music.stop()

                pygame.mixer.music.stop()

                # Display "YOU WIN!" for 1 second
