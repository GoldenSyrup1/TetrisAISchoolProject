...
class TetrisGame():
    def __init__(self):
        ...
        # SHAPE FORMATS
        self.four_S = [['.....', '.....', '..00.', '.00..', '.....'], ['.....', '..0..', '..00.', '...0.', '.....']]
        self.four_Z = [['.....','.....', '.00..','..00.','.....'],['.....','..0..','.00..','.0...','.....']]
        self.four_I = [['..0..','..0..', '..0..', '..0..', '.....'], ['.....', '0000.', '.....', '.....', '.....']]
        self.four_O = [['.....', '.....','.00..','.00..','.....']]
        self.four_J = [['.....','.0...','.000.','.....','.....'],['.....','..00.','..0..','..0..','.....'],
                       ['.....','.....','.000.','...0.','.....'],['.....','..0..','..0..','.00..','.....']]
        self.four_L = [['.....', '...0.','.000.','.....','.....'],['.....','..0..','..0..','..00.','.....'],['.....',
                        '.....', '.000.','.0...','.....'],['.....','.00..','..0..','..0..','.....']]
        self.four_T = [['.....', '..0..','.000.','.....','.....'],['.....','..0..','..00.','..0..','.....'],['.....',
                        '.....', '.000.', '..0..', '.....'], ['.....','..0..','.00..','..0..','.....']]
        self.three_I = [['.....','..0..','..0..','..0..','.....'],['.....','.....','.000.','.....','.....']]
        self.three_J = [['.....','...0.','..00.','.....','.....'],['.....','...0.','...00','.....','.....'],['.....',
                         '.....','...00','...0.','.....'],['.....','.....','..00.','...0.','.....']]
        self.two_I = [['.....','..0..','..0..','.....','.....'],['.....','..00.','.....','.....','.....']]
    ...
    def down_once(self, current_piece, grid):
        ...
        if not self.valid_space(current_piece, grid):
            current_piece.y -= 1
            return False  # Return False if movement wasn't possible
        return True  # Return True if movement was successful

    def space_once(self, current_piece, grid):
        while self.valid_space(current_piece, grid):
            current_piece.y += 1
        current_piece.y -= 1
        # After hard drop, immediately check if piece is valid
        if not self.valid_space(current_piece, grid):
            current_piece.y -= 1  # Move up one more if still invalid
